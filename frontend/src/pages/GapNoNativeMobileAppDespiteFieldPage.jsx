...
// Gap (Non-AI): No native mobile app despite field
// No native mobile app despite field-worker domain
import React, { useState } from 'react';

export default function GapNoNativeMobileAppDespiteFieldPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-native-mobile-app-despite-field/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No native mobile app despite field</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No native mobile app despite field-worker domain</p>
