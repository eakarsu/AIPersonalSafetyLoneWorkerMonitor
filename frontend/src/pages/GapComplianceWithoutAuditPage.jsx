...
// Gap (AI): Compliance without '/audit
// Compliance without /audit-readiness-score (predict compliance audit results)
import React, { useState } from 'react';

export default function GapComplianceWithoutAuditPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-compliance-without-audit/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Compliance without '/audit</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Compliance without /audit-readiness-score (predict compliance audit results)</p>
