...
// Custom Feature: Behavioral risk profiling
// Behavioral risk profiling: Combine location patterns, communication tone, schedule load; identify workers in distress (mental health, burnout); proactive intervention offers
import React, { useState } from 'react';

export default function CFBehavioralRiskProfilingPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-behavioral-risk-profiling/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Behavioral risk profiling</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Behavioral risk profiling: Combine location patterns, communication tone, schedule load; identify workers in distress (mental health, burnout); proactive intervention offers</p>
