...
// Equipment without /equipment-failure-predict (flag PPE nearing expiration)
...
async function callLLM(systemPrompt, userPrompt) {
  ...
  const res = await fetchFn('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'X-Title': 'AIPersonalSafetyLoneWorkerMonitor / gap-equipment-without-equipment',
    },
    body: JSON.stringify({
